...
val LocalNavigatorSaver: ProvidableCompositionLocal<NavigatorSaver<*>> =
 ...
 */
fun defaultNavigatorSaver(): NavigatorSaver<Any> = NavigatorSaver { _, key, stateHolder, disposeBehavior, parent ->
    listSaver(
